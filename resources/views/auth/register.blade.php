<x-guest-layout>
    <x-slot name="footer">
        <div class="auth-icon-row" aria-label="Alternative registration methods">
    ...
    <h1 class="auth-heading">{{ __('Create Account') }}</h1>
    <p class="auth-subheading">{{ __('Fill in your details, then sign in to continue.') }}</p>
